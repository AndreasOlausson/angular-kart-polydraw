...
module.exports = "\r\np {\r\n  font-family: Lato;\r\n}\r\n.polydrawbuttons {\r\n  display: -webkit-box;\r\n  display: flex;\r\n  position: absolute;\r\n  z-index: 1000;\r\n  top: 10px;\r\n  left: 50px;\r\n}\r\n.button {\r\n  margin: 4px;\r\n  padding: 4px;\r\n  background-color: lightblue;\r\n  border: 1px solid black;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
/*!*********************************!*\
  !*** ./src/app/map/config.json ***!
  \*********************************/
/*! exports provided: polyLineOptions, subtractLineOptions, polygonOptions, default */
/***/ (function(module) {

module.exports = {"polyLineOptions":{"color":"#50622b","opacity":1,"smoothFactor":0,"noClip":true,"clickable":false,"weight":2},"subtractLineOptions":{"color":"#50622b","opacity":1,"smoothFactor":0,"noClip":true,"clickable":false,"weight":2},"polygonOptions":{"smoothFactor":0.3,"color":"#50622b","fillColor":"#b4cd8a","noClip":true}};
...
var MapHelperService = /** @class */ (function () {
    function MapHelperService(mapState, turfHelper, polygonInformation) {
        var _this = this;
        ...
        this.tracer = leaflet__WEBPACK_IMPORTED_MODULE_1__["polyline"]([[0, 0]], _config_json__WEBPACK_IMPORTED_MODULE_7__.polyLineOptions);
        this.divIcon = leaflet__WEBPACK_IMPORTED_MODULE_1__["divIcon"]({ className: "polygon-marker" });
    ...
    MapHelperService.prototype.deletePolygon = function (polygon) {
        ...
        if (this.arrayOfFeatureGroups.length > 0) {
            this.arrayOfFeatureGroups.forEach(function (featureGroup) {
                ...
                console.log(latlngs);
                var equals = _this.polygonArrayEquals(polygon2, polygon);
                if (equals) {
                    ...
                    _this.polygonInformation.updatePolygons();
                }
            });
        }
    };
    ...
    MapHelperService.prototype.addAutoPolygon = function (geographicBorders) {
        ...
        markerLatlngs.forEach(function (polygon) {
            _this.addMarker(polygon[0], featureGroup);
        });
    ...
    MapHelperService.prototype.polygonClicked = function (e, poly) {
        var imutableClone = (JSON.parse(JSON.stringify(poly)));
        //this.getLatLngsFromJson(feature)
        var newPoint = e.latlng;
        var idx = -1;
        var idx2 = -1;
        var tmpDistance = Number.MAX_SAFE_INTEGER;
    ...
    MapHelperService.prototype.getPolygon = function (latlngs) {
        ...
        polygon.setStyle(_config_json__WEBPACK_IMPORTED_MODULE_7__.polygonOptions);
        return polygon;
    };
    ...
    MapHelperService.prototype.addMarker = function (latlngs, FeatureGroup) {
        ...
        latlngs.forEach(function (latlng) {
            var marker = new leaflet__WEBPACK_IMPORTED_MODULE_1__["Marker"](latlng, { icon: _this.divIcon, draggable: true });
    ...
    MapHelperService.prototype.markerDrag = function (FeatureGroup) {
        ...
        var posarrays = FeatureGroup.getLayers()[0].getLatLngs();
        var length = 0;
        if (posarrays.length > 1) {
            for (var index = 0; index < posarrays.length; index++) {
                testarray = [];
                if (index === 0) {
                    for (var j = 0; j < posarrays[index][0].length; j++) {
            ...
            for (var index = 1; index < layerLength.length; index++) {
    ...
    MapHelperService.prototype.markerDragEnd = function (FeatureGroup) {
        ...
        var featureCollection = FeatureGroup.toGeoJSON();
        var feature = this.turfHelper.getTurfPolygon(featureCollection.features[0]);
        if (this.turfHelper.hasKinks(feature)) {
            this.kinks = true;
            var unkink = this.turfHelper.getKinks(feature);
            this.deletePolygon(this.getLatLngsFromJson(feature));
            unkink.forEach(function (polygon) {
                _this.addPolygon(_this.turfHelper.getTurfPolygon(polygon), false);
            });
        }
        else {
            this.kinks = false;
    ...
    MapHelperService.prototype.unionPolygons = function (layers, latlngs) {
        var _this = this;
        console.log("unionPolygons", layers, latlngs);
        var addNew = latlngs;
        layers.forEach(function (featureGroup) {
            var featureCollection = featureGroup.toGeoJSON();
            var layer = featureCollection.features[0];
            var geoLayer = featureCollection.features[0];
            var poly = _this.getLatLngsFromJson(layer);
            var union = _this.turfHelper.union(addNew, geoLayer);
            _this.deletePolygonOnMerge(poly);
            _this.removeFeatureGroup(featureGroup);
            addNew = union;
        });
        var newLatlngs = addNew;
    ...
    MapHelperService.prototype.deletePolygonOnMerge = function (polygon) {
        ...
        if (this.arrayOfFeatureGroups.length > 0) {
            this.arrayOfFeatureGroups.forEach(function (featureGroup) {
                ...
                var equals = _this.polygonArrayEqualsMerge(latlngs, polygon);
                if (equals) {
    ...
    MapHelperService = __decorate([
        ...
        __metadata("design:paramtypes", [_map_state_service__WEBPACK_IMPORTED_MODULE_4__["MapStateService"], _turf_helper_service__WEBPACK_IMPORTED_MODULE_5__["TurfHelperService"], _polygon_information_service__WEBPACK_IMPORTED_MODULE_6__["PolygonInformationService"]])
    ], MapHelperService);
...
var MapComponent = /** @class */ (function () {
    ...
    MapComponent.prototype.initMap = function () {
        this.map = new leaflet__WEBPACK_IMPORTED_MODULE_1__["Map"]("map");
        this.map.setView(new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](59.911491, 10.757933), 16);
        ...
        leaflet__WEBPACK_IMPORTED_MODULE_1__["tileLayer"]("https://{s}.tile.openstreetmap.fr/hot/{z}/{x}/{y}.png", {
            maxZoom: 20,
            maxBounds: [
                [90, -180],
                [-90, 180]
...
var PolygonInformationService = /** @class */ (function () {
    ...
    PolygonInformationService.prototype.deleteTrashcan = function (polygon) {
        var idx = this.polygonInformationStorage.findIndex(function (v) { return v.polygon === polygon; });
    ...
    PolygonInformationService.prototype.createPolygonInformationStorage = function (arrayOfFeatureGroups) {
        ...
        if (arrayOfFeatureGroups.length > 0) {
            arrayOfFeatureGroups.forEach(function (featureGroup) {
                ...
                var polyInfo = new _polygon_helpers__WEBPACK_IMPORTED_MODULE_2__["PolygonInfo"](featureGroup.getLayers()[0].getLatLngs()[0][0]);
...
/*!********************************************!*\
  !*** ./src/app/map/turf-helper.service.ts ***!
  \********************************************/
/*! exports provided: TurfHelperService, Compass */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var TurfHelperService = /** @class */ (function () {
    function TurfHelperService() {
        this.simplifyTolerance = { tolerance: 0.000001, highQuality: false };
    }
    ...
    TurfHelperService.prototype.polygonIntersect = function (polygon, latlngs) {
        ...
        latlngsCoords.forEach(function (element) {
            var feat = { type: "Polygon", coordinates: element };
            poly.push(feat);
        });
    ...
    TurfHelperService.prototype.injectPointToPolygon = function (polygon, point) {
        ...
        if (coords.length < 2) {
            var polygonPoints_1 = _turf_turf__WEBPACK_IMPORTED_MODULE_1__["explode"](polygon);
            console.log(_turf_turf__WEBPACK_IMPORTED_MODULE_1__["nearestPoint"](point, polygonPoints_1));
            var index_1 = _turf_turf__WEBPACK_IMPORTED_MODULE_1__["nearestPoint"](point, polygonPoints_1).properties.featureIndex;
            var test = _turf_turf__WEBPACK_IMPORTED_MODULE_1__["coordReduce"](polygonPoints_1, function (accumulator, oldPoint, i) {
                if (i === index_1) {
                    var l = _turf_turf__WEBPACK_IMPORTED_MODULE_1__["distance"](point, polygonPoints_1.features[i === 0 ? polygonPoints_1.features.length : i - 1].geometry.coordinates, { units: "degrees" });
                    var r = _turf_turf__WEBPACK_IMPORTED_MODULE_1__["distance"](point, polygonPoints_1.features[i === polygonPoints_1.features.length ? 0 : i + 1].geometry.coordinates, { units: "degrees" });
                    console.log("Left: ", l);
                    console.log("Right: ", r);
                    if (l < r) {
                        console.log("Index til v :", i === 0 ? polygonPoints_1.features.length : i - 1, " er nærmest: ", polygonPoints_1.features[i === 0 ? polygonPoints_1.features.length : i - 1].geometry.coordinates);
                        return accumulator.concat([
                            polygonPoints_1.features[i === 0 ? polygonPoints_1.features.length : i - 1].geometry.coordinates,
                            point,
                            oldPoint,
                        ]);
                    }
                        ...
                        return accumulator.concat([
                            oldPoint,
                            point,
                            polygonPoints_1.features[i === polygonPoints_1.features.length ? 0 : i + 1].geometry.coordinates,
                        ]);
                    }
                }
...
module.exports = __webpack_require__(/*! C:\Users\trg\Documents\angular-kart-polydraw\src\main.ts */"./src/main.ts");
