(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('leaflet'), require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('@turf/turf'), require('concaveman')) :
    typeof define === 'function' && define.amd ? define('my-lib', ['exports', 'leaflet', 'rxjs', 'rxjs/operators', '@angular/core', '@turf/turf', 'concaveman'], factory) :
    (global = global || self, factory(global['my-lib'] = {}, global.leaflet, global.rxjs, global.rxjs.operators, global.ng.core, global.turf, global.concaveman));
}(this, (function (exports, leaflet, rxjs, operators, core, turf, concaveman) { 'use strict';
